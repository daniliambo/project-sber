...
abstract class S5 extends DerivedTable[Row] {
...
object S5 extends S5 {
  override def className: String                                                        = "S5"
  ...
  override def name: String = s"S5Name"

  override def dependencies: Seq[WorkflowTask[_]] = Seq(S1, S3, getter1, getter2, getter3)
  ...
  override protected def getS2(implicit spark: SparkSession): Dataset[Row] = ???

  override protected def getS3(implicit spark: SparkSession): Dataset[Row] = S3.get
